...
const config = {
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by ✦ 𝐂𝐲𝐛𝐞𝐫 𝐂𝐫𝐲𝐩𝐭𝐨 𝐊𝐢𝐧𝐠°🪙°👑',
  ...
  OWNER_NAME: process.env.OWNER_NAME || "✦ 𝐂𝐲𝐛𝐞𝐫 𝐂𝐫𝐲𝐩𝐭𝐨 𝐊𝐢𝐧𝐠°🪙°👑",
  AUTO_BLOCK: process.env.AUTO_BLOCK || "",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923140053156",
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "923140053156",
